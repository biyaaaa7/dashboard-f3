...
const NAV_ITEMS = [
  ...
  { name: 'History Log', href: '/manager/history', icon: History },
  { name: 'Export Data', href: '/manager/export', icon: Download },
];
            ...
            return (
              ...
              >
                <item.icon className={cn(
                  "h-5 w-5 shrink-0", 
                  isActive ? "text-blue-400" : "text-slate-400 group-hover:text-slate-50",
